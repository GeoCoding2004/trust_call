...
- `cadvisor` at `cadvisor:8080/metrics` when the optional `cadvisor` profile is enabled

Grafana is provisioned automatically with:

- Prometheus datasource.
- `Trust-Call AI Services` dashboard generated by `scripts/generate_grafana_dashboard.py`.
- Rows for readiness, traffic, latency, RawNet, DistilBERT, Whisper, IEP3, fusion, data quality, security, and optional resource metrics.
- Detailed metric inventory and PromQL examples in `docs/observability.md`.
